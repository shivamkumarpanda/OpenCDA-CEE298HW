...
def clustering(point_cloud: o3d.geometry.PointCloud,
    ...
    clusters = np.array(point_cloud.cluster_dbscan(eps=2.0, min_points=min_cluster_size, print_progress=True))
    # END TODO
...
def compute_3d_bounding_boxes(cluster_labels, point_cloud):
    ...
    for label in unique_labels:
        ...
        # cluster_points = point_cloud.select_by_index(np.where(cluster_labels==label)).points
