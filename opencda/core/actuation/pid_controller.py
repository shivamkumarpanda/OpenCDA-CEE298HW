...
class Controller:
    ...
    def __init__(self, args):
        ...
        self.speed_log_file = "/home/asjchoi/Downloads/Project3/OpenCDA-2/OpenCDA/speed_log.txt"

        # Open the file in append mode
        with open(self.speed_log_file, 'w') as f:
            f.write("Time Step,Current Speed,Target Speed\n")  # Write headers
    ...
    def dynamic_pid(self):
        ...
        """
        # Baseline PID gains
        kp_lon_base, kd_lon_base, ki_lon_base = 1, 0.5, 0.1
        kp_lat_base, kd_lat_base, ki_lat_base = 0.2, 0.1, 0.1
    ...
    def run_step(self, target_speed, waypoint):
        ...
        with open(self.speed_log_file, 'a') as f:
            f.write(f"{self.dt},{self.current_speed},{target_speed}\n")
